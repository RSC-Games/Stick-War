...
public class RenderTestTextures extends Scene {
    public RenderTestTextures(String name, int uuid) {
        ...
        sprites.add(new BasicTexturePainter(new Point(15, 15), 0, "Tex0", "./images/colored_checkerboard.png"));
        ...
        sprites.add(new DrawText(new Point(3, 26), 0, "Text", "TEST: Drawing textures", Color.green));
        /* End UI Panel */
