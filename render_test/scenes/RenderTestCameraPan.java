...
public class RenderTestCameraPan extends Scene {
    public RenderTestCameraPan(String name, int uuid) {
        ...
        sprites.add(new BasicTexturePainter(new Transform(Point.zero), "Background", "./images/checkerboard.png"));
        ...
        sprites.add(new DrawText(new Transform(new Point(3, 26)), "Text", "TEST: Camera panning", Color.green));
        /* End UI Panel */
